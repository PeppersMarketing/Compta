...
class Produit
{
    ...
    public function getManufactureur(): ?string
    {
        return $this->Manufactureur;
    }

    public function setManufactureur(string $Manufactureur): self
    {
        $this->Manufactureur = $Manufactureur;
